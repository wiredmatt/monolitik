    ...
    <section id="hero" class="w-full pb-24">
      <BaseSection>
        ...
        >
          ...
          >
            {{ settings.landingSlugS1 }}
            <span class="text-header-gradient">
              {{ settings.landingSlugS2 }}
            </span>
            {{ settings.landingSlugS3 }}
          </h1>
          <p
            data-aos="fade-down"
            data-aos-once="true"
      ...
      <BaseSection data-aos="fade-down">
        ...
        >
          <h2 class="text-4xl font-semibold">
            Introducing the
            <span class="text-header-gradient">NEFA</span> Credit
            Card
          </h2>
          <p class="paragraph">
          ...
          <ul class="space-y-4 sm:space-y-2">
            <LandingListItem
              title="Up to 3% back on purchases"
            />
            <LandingListItem
        ...
        >
          ...
          <div class="space-y-2">
            ...
            <p class="paragraph text-sm xl:text-base">
              ...
              liquidity, reliable order execution and constant
              uptime.
            </p>
          </div>
          <div class="space-y-2">
      ...
      >
        ...
        >
          <div class="w-full">
            <img
              :src="
                require('~/assets/img/industry-leading-security.webp')
              "
              class="w-full"
              alt=""
            />
    ...
    >
      <div class="w-full py-16 flex flex-col items-center">
        ...
        >
          ...
          <img
            :src="
              require('~/assets/img/getting-started/arrow.png')
            "
    ...
    <section class="w-full my-24">
      <BaseSection>
        ...
        >
          ...
          >
          <h2
            class="text-3xl sm:text-4xl font-semibold mb-10 sm:mb-6"
          >
...
const settings = require('settings/frontend.json')
